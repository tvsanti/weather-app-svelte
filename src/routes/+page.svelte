<script lang="ts">
  ...
  onMount(async () => {
    fetch(
      "https://api.open-meteo.com/v1/forecast?latitude=36.7202&longitude=-4.4203&current=temperature_2m&hourly=apparent_temperature&forecast_days=1&daily=weather_code,temperature_2m_max,temperature_2m_min,sunrise,sunset"
    )
  ...
  <div class="selected_day">
    <div class="general_info">
      ...
      <div class="current_weather">
        <span class="temeratureNumber">{$apiData.current.temperature_2m}º</span>
        <span>Clear skies, possible cyclone</span>
      </div>
      <div class="min_max_weather">
        <DailyTemperatureSummary description={"Max"} temerature={$apiData.daily.temperature_2m_max[0]}/>
        <DailyTemperatureSummary description={"Min"} temerature={$apiData.daily.temperature_2m_min[0]}/>
      </div>
    </div>
